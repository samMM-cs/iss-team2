...
public class MapView2 extends Pane {
    ...
    public MapView2(List<LayerData> layers, List<SpritePosition> sprites,
    ...
    private Position calculateCameraOffset(double viewWidth, double viewHeight) {
        ...
        return viewport.scale(.5)
                .sub(playerPosition)
                .clamp(viewport.sub(new Position(this.width, this.height)
                        .scale(renderedTileSize)),
                        Position.Origin);
    }
