...
public class MapView___UNUSED extends Pane {
    ...
    public MapView___UNUSED(String mapFilePath, String tileSetImagePath) {
    ...
    private static List<Integer> getWalkableIds() {
        try {
            URL url = MapView___UNUSED.class.getResource("/maps/punyworld-overworld-tiles.tsx");
