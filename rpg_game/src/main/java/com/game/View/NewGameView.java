...
public class NewGameView extends GameView{
    ...
    public void load() {
        ...
        /*
         * nPlayersButtons.setStyle("-fx-border-color: red; -fx-background-color: rgba(255,0,0,0.2);");
         * autoSaveButtons.setStyle("-fx-border-color: blue; -fx-background-color: rgba(0,0,255,0.2);");
